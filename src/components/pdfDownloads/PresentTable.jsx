...
export const PresentTable = ({heading,header, data}) => {
                        ...
                        <table
                           ...
                           <tbody>
                                 {data?.map((i, index) => <tr class="border-b border-neutral-200 dark:border-white/10">
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4">{convertDate(i?.checkin, "monthAndDay")}</td>
                                    <td class="whitespace-nowrap  px-6 py-4">{convertDate(i?.checkin, "time")}</td>
                                    <td class="whitespace-nowrap  px-6 py-4">{convertDate(i?.checkout, "time")}</td>
                                    <td class="whitespace-nowrap  px-6 py-4">{i?.status}</td>
                                </tr>)}
                            </tbody>
                        </table>
                    </div>
