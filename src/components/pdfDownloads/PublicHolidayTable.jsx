...
export const PublicHolidayTable = ({ heading, header, data }) => {
                        ...
                        <table
                            ...
                            <tbody>
                                {data?.map((i,index)=><tr class="border-b border-neutral-200 dark:border-white/10">
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4">{convertDateWithoutTime(i?.holidayDate, "monthAndDay")}</td>
                                    <td class="whitespace-nowrap  px-6 py-4">{i?.reasonForLeave}</td>
